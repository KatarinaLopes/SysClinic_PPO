...
public class LoginAdministradorFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("LoginAdministradorFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("LoginAdministradorFilter:DoAfterProcessing");
        }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("LoginAdministradorFilter()");
        }
        StringBuffer sb = new StringBuffer("LoginAdministradorFilter(");
