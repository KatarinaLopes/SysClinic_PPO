...
/**
 * EN-US
 * Class to manage all operations related to Funcionario
 * 
 * PT-BR
 * Classe para gerenciar todas as operações relacionadas a Funcionario
 * 
 * @author Katarina
 */
public class FuncionarioManager {
    ...
    /**
     * EN-US
     * Method to validate the given Funcionario, if the passwords are equal and
     * if there's already a Funcionario with the same matricula in DB
     * If the passwords aren't equal or there's already a Funcionario 
     * registered, a IllegalArgumentException will be thrown
     * 
     * 
     * PT-BR
     * Método para validar o Funcionario dado, se as senha são iguais e se já
     * existe um Funcionario com a mesma matrícula no BD
     * Se as senhas não são iguais ou já tem um Funcionario cadastrado, uma
    ...
    /**
     * EN-US
     * Validates the Funcionario and then persists it
     * 
     * PT-BR
     * Valida o Funcionario e depois o persiste
    ...
    /**
     * EN-US
     * Retrieves a Funcionario from DB with the given id
     * 
     * PT-BR
     * Recupera um funcionario do BD com a id dada
     * @param id
     * @return a Funcionario, if exists, null if it doesn't | um Funcionario, 
     * se existir, null se não
     */
    ...
    /**
     * EN-US
     * Updates the given Funcionario
     * 
     * PT-BR
     * Atualiza o funcionario dado
    ...
    /**
     * EN-US
     * Deletes the given Funcionario from the DB
     * 
     * PT-BR
     * Deleta o funcionario dado do BD
     * @param funcionario representing the Funcionario | representando o 
     * funcionario
     */
    ...
    /**
     * EN-US
     * Retrieves all Funcionario from DB
     * 
     * PT-BR
     * Recupera todos os Funcionario do BD
    ...
    /**
     * EN-US
     * Verifies if there's more than one Funcionario, according to it's 
     * privilege (if Administrador or not)
     * 
     * PT-BR
     * Verifica se existe mais de um Funcionario, de acordo com seu privilégio
     * (se administrador ou não)
    ...
    /**
     * EN-US
     * Returns an alert message about changing a Funcionario privilege
     * 
     * PT-BR
     * Retorna uma mensagem de alerta sobre mudar o privilégio de um 
     * Funcionario
     * 
